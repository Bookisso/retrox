          ...
          >
            <div className="relative px-20 py-8 flex-auto mx-auto text-center text-xl">
              ...
              <div className="grid grid-rows-4 grid-cols-3">
                {Object.keys(props.badgeholderList).map(
                  (key, value) =>
                    key < Object.keys(props.badgeholderList).length && (
                      <a
                        href={
                          "https://twitter.com/" +
                          props.badgeholderList[key].slice(1)
                        }
                        target="_blank"
                        rel="noreferrer"
                        className="m-1 text-blue-500 hover:text-blue-700"
                      >
                        {props.badgeholderList[key]}
                      </a>
                    )
                )}
              </div>
