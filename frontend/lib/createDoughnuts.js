...
export function createDoughnutData(project, projectName) {
  ...
  for (const [key, value] of Object.entries(project)) {
    ...
    // }
    if (key !== projectName) {
      returnData.datasets[0].backgroundColor.push("#0700CF");
      returnData.datasets[0].hoverBackgroundColor.push("#0700CF80");
    } else {
      returnData.datasets[0].backgroundColor.push("#1AACAC");
      returnData.datasets[0].hoverBackgroundColor.push("#1AACAC80");
    }
    if (value != null) {
